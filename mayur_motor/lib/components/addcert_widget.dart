import '/components/paymentcard_widget.dart';
...
import 'addcert_model.dart';
export 'addcert_model.dart';

class AddcertWidget extends StatefulWidget {
  const AddcertWidget({super.key});

  @override
  State<AddcertWidget> createState() => _AddcertWidgetState();
}

class _AddcertWidgetState extends State<AddcertWidget> {
  late AddcertModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AddcertModel());
                    ...
                    Expanded(
                      child: Padding(
                        ...
                        child: FlutterFlowDropDown<String>(
                          controller: _model.myBioValueController ??=
                              FormFieldController<String>(null),
                          options: const ['LMV', 'HGV', 'ARTR', 'Other'],
                          onChanged: (val) =>
                              setState(() => _model.myBioValue = val),
                          width: 300.0,
                          height: 56.0,
                          textStyle:
                              FlutterFlowTheme.of(context).bodyMedium.override(
                ...
                Container(
                  ...
                  child: Padding(
                    ...
                    child: TextFormField(
                      ...
                      obscureText: false,
                      decoration: InputDecoration(
                        labelText: 'Cost for Certificarion',
                        labelStyle:
                            FlutterFlowTheme.of(context).labelMedium.override(
                                  fontFamily: 'Readex Pro',
                                  letterSpacing: 0.0,
